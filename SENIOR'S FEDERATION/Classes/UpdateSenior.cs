...
namespace SENIOR_S_FEDERATION.Classes
{
    public class UpdateSenior
    {
        ...
        public UpdateSenior(string _fullname, string _address, string _birthday, string _federationid, string _addmissiondate, string _oscaid, int _id)
        {
